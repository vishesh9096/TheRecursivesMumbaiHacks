...
with_node --no-warnings --eval "require('expo-modules-autolinking')(process.argv.slice(1))" generate-package-list  --target "/Users/macbookpro/Desktop/TheRecursives_HACK_CBS/ios/Pods/Target Support Files/Pods-reactnativestarter-reactnativestarterTests/ExpoModulesProvider.swift"
